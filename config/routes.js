...
'POST /api/v1/conditions': { controller: 'ConditionsController',action:'create',swagger: {
...
'GET /api/v1/conditions': { controller: 'ConditionsController',action:'get',swagger: {
  tag: ['conditions-get'],
...
'POST /api/v1/users/conditions': { controller: 'ConditionsController',action:'setConditionAndUser',swagger: {
  tag: ['conditions-set'],
...
'GET /api/v1/users/conditions': { controller: 'ConditionsController',action:'getByUser',swagger: {
